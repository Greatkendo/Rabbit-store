 ...
 return(
  <section className="py-16 px-4 lg:px-0">
   <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
    ...
    <Link href={"/collections/all"} className="bg-black text-white px-6 py-3 rounded-lg text-lg hover:bg-gray-800">
    Shop Now
    </Link>
    </div>
    ...
    <img src="/friends.jpg" alt="shirt" className="w-full h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl"/>
    </div>
   </div>
  </section>
 );
